...
<head>
    ...
    <script src="clique.js"></script>
    <script src="touche.js"></script>
    <script src="train1.js"></script>
    <script src="train2.js"></script>
    <script src="voiture.js"></script>
    <script src="occupation2.js"></script>
    <script src="occupation1.js"></script>
    <script src="son.js"></script>
    <script src="parcours2.js"></script>
    ...
    <script src="fermetureTroncon.js"></script>

    <script src="ampli.js"></script>
    <script src="audrey.js"></script>
    <script src="eclair.js"></script>
    <script src="incendie.js"></script>
    <script src="jean_marc.js"></script>
    <script src="marion.js"></script>
    <script src="neige.js"></script>
    <script src="noel.js"></script>

    <script src="train_IR2.js"></script>
    <script src="train_IR3.js"></script>
    <script src="afficheScore.js"></script>
    ...
    <script type="text/javascript">
        ...
        function affiche_clientchef() {
            const image_client = new Image();

            image_client.onload = function() {
                document.getElementById("clientchef").src = image_client.src;
            }
            image_client.src = "image/client/" + nom_client + "_" + couleur + ".jpg";

            const image_boite = new Image();

            image_boite.onload = function() {
                document.getElementById("boite_textechef").src = image_boite.src;
            }
        ...
        function affichage_image() {
            ...
            if (minutes_de_retard >= 0 && minutes_de_retard <= 5) {
                document.getElementById("UnTexte_c2").innerHTML = 'Minutes de retard : <span style="color: green;"><b>	' + minutes_de_retard + ' </b><i> max 15</i></span>';
            }

            if (minutes_de_retard >= 6 && minutes_de_retard <= 10) {
                document.getElementById("UnTexte_c2").innerHTML = 'Minutes de retard : <span style="color: orange;"><b>	' + minutes_de_retard + ' </b><i> max 15</i></span>';
            }

            if (minutes_de_retard >= 11 && minutes_de_retard <= 30) {
                document.getElementById("UnTexte_c2").innerHTML = 'Minutes de retard : <span style="color: red;"><b>	' + minutes_de_retard + ' </b><i> max 15</i></span>';
            }
        }
        ...
        function la_date2() {
            ...
            if (les_secondes == 60) {
                les_minutes = les_minutes + 1;
                les_secondes = 0;
            }
            if (les_minutes == 60) {
                les_heures = les_heures + 1;
                les_minutes = 0;
            }
            if (les_heures == 24) {
                les_heures = 0;
...
<body style="background-color: black;" onclick="onclick_page(event);" onmousemove="souris(event);" onkeyPress="quelle_touche(event);">
    ...
    <div id="gare_5">
        <img src="image/fond/1005.php" style="position: absolute; left: 100px; top: 100px;" alt="image" id="la_gare_5" />
    </div>
    ...
    <div id="gare_4">
        <img src="image/fond/1004.php" style="position: absolute; left: 100px; top: 100px;" alt="image" id="la_gare_4" />
    </div>
    ...
    <!-- La gare 1 -->
    <div id="gare_1">
        <img src="image/fond/1001.php" style="position: absolute; left: 100px; top: 100px;" alt="image1" id="la_gare_1" />
    </div>

    <!-- Cache gris bas -->
    <div id="cache">
        <img src="image/fond/cache_gris.png" style="position: absolute; left: 100px; top: 440px;" alt="image" id="cache_gris" />
    </div>

    <!-- quai 1 dessin carré -->
    <div id="quai1">
        <img src="image/fond/quai2.png" style="position: absolute; left: 600px; top: 535px;" alt="image" id="lequai1" />
    </div>


    <!-- quai 2 dessin carré -->
    <div id="quai2">
        <img src="image/fond/quai2.png" style="position: absolute; left: 600px; top: 625px;" alt="image" id="lequai2" />
    </div>

    <!-- quai 3  dessin carré -->
    <div id="quai2">
        <img src="image/fond/quai1.png" style="position: absolute; left: 600px; top: 715px;" alt="image" id="lequai3" />
    </div>
    ...
    <!-- PN -->
    <div id="route1">
        <img src="image/PN/route1.png" style="position: absolute; left: 1170px; top: 477px;" alt="image" id="une_image_route1" />
    </div>

    <div id="route2">
        <img src="image/PN/route2.png" style="position: absolute; left: 1187px; top: 442px;" alt="image" id="une_image_route2" />
    </div>

    <div id="route3">
        <img src="image/PN/1090.php" style="position: absolute; left: 1185px; top: 445px; width: 50px;" alt="image" id="une_image_route3" />
    </div>

    <div id="route4">
        <img src="image/PN/feux0.png" style="position: absolute; left: 1216px; top: 464px; width: 23px;" alt="image" id="une_image_route4" />
    </div>

    <div id="cache_droite">
        <img src="image/fond/cache_droite.jpg" style="position: absolute; left: 1299px; top: 100px;" alt="image" id="une_image_cache_droite" />
    </div>

    <div id="cache_gauche">
        <img src="image/fond/cache_gauche.jpg" style="position: absolute; left: 0px; top: 100px;" alt="image" id="une_image_cache_gauche" />
    </div>

    <div id="cache_haut">
        <img src="image/fond/cache_haut.jpg" style="position: absolute; left: 0px; top: -28px;" alt="image" id="une_image_cache_haut" />
    </div>

    <div id="lien1" style="position: absolute; left: 120px; top: 90px; color: white; font-size: 20px;">
        <p id="UnTexte_c40">MA GARE MES TRAINS (et le chef)</p>
    </div>
    ...
    <div id="lien11" style="position: absolute; left: 490px; top: 88px; color: white; font-size: 22px;">
        <p id="heure1"></p>
    </div> <!-- indication de l'heure du jeux -->

    <div id="lien18" style="position: absolute; left: 610px; top: -100px; color: white; font-size: 14px;">
        <p id="UnTexte_c25">Total train :</p>
    </div> <!-- Affiche total train -->

    <div id="lien18" style="position: absolute; left: 730px; top: -95px; color: white; font-size: 12px;">
        <p id="UnTexte_c18">En retard : 0</p>
    </div> <!-- Affiche retard train -->

    <div id="lien18" style="position: absolute; left: 835px; top: -95px; color: white; font-size: 12px;">
        <p id="UnTexte_c19">A l'heure : 0</p>
    </div> <!-- Affiche a l'heure train -->

    <div id="lien18" style="position: absolute; left: 950px; top: -95px; color: white; font-size: 12px;">
        <p id="UnTexte_c20">Score : 0</p>
    </div> <!-- Affiche scoretrain -->

    <div id="lien19" style="position: absolute; left: 1065px; top: -140px; color: white; font-size: 12px;">
        <p id="UnTexte_c22">Total retard :</p>
    </div>

    <!-- Affichage des scores -->

    <!-- A contrôler si demandé ??????????????????????????????????????????????????????????????????????????????????? 52 -->
    <div id="score" style="position: absolute; left: 946px; top: -100px; color: white; font-size: 16px;">
        <p id="UnTexte_c52">Ici les score ?????</p>
    </div>

    <!-- Voir si séparer le nom du la valeur nom ???????????????????????????????????????????????????????????????????????????????????????????????????? -->
    <div id="lien18" style="position: absolute; left: 610px; top: 100px; 	color: white; font-size: 14px;">
        <p id="UnTexte_c1">Nombre de trains :</p>
    </div>
    <div id="lien19" style="position: absolute; left: 830px; top: 100px; 	color: white; font-size: 14px;">
        <p id="UnTexte_c2">Minutes de retard :</p>
    </div>
    <div id="loginnom" style="position: absolute; left: 1030px; top: 100px; color: white; font-size: 16px;">
        <p id="UnTexte_c50"><?php echo $nom; ?></p>
    </div>
    ...
    <script type="text/javascript">
        ...
        train2_its111[3] = 0;
        train2_its111[4] = 1;
        train2_its111[5] = '100 IC Lausanne ';
        train2_its111[6] = 100;
